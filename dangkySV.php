...
<body>
    <div class="container mt-1">
		<div class="jumbotron jumbotron-fluid">
			<center><h1 class="display-3">THÔNG TIN SINH VIÊN ĐĂNG KÝ</h1></center>
		</div>
	</div>
	<?php
		...
		$sql = 'SELECT loginstudent.ID, loginstudent.TenSV, loginstudent.HocPhanDK, loginstudent.GiangVien, loginstudent.Diem, loginstudent.MaSV, loginstudent.Lop FROM loginstudent 
			';
			...
			while ($dl = $result->fetch_assoc()) {
				echo '
						<tr>
							...
							<td>'.$dl['GiangVien'].'</td>
							<td>'.$dl['Lop'].'</td>
							<td><form action="xemdiem.php"  method="POST">
