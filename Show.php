...
<body>
	...
	<?php  
		...
		$sql = 'SELECT lophp.ID,lophp.TenLop,dangky.diem,dangky.NamHoc,dangky.HocKy FROM dangky JOIN lophp ON dangky.ID_LopHP = lophp.ID WHERE MaSV="'.$_POST['id'].'"';
            ...
            ?>
             <td>
					 <input type="text" class="d-none" name="id" value='.$dl['MaSV'].'>
				      	<center><a href="dangky.php"><button class="btn btn-outline-success">Trở lại</button></a></center>
				      </td>
