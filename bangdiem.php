...
<body>
	...
	<?php  
		...
		$sql = 'SELECT diemsinhvien.ID, diemsinhvien.Tenhocphan, diemsinhvien.TenSV, diemsinhvien.Diem, diemsinhvien.Lop FROM diemsinhvien  WHERE ID = "'.$_POST['id3'].'"';
		...
		If ($result->num_rows > 0) {
            ...
            ?>
             		<td>
					 <input type="text" class="d-none" name="id1" value='.$dl['MAGiangVien'].'>
				      <center><a href="index2.php"><button class="btn btn-outline-success">Trở lại</button></a></center>
				</td>
      </div>
    <!-- Optional JavaScript -->
