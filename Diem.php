...
<body>
	...
	<?php  
		...
		$sql = 'SELECT svdkadmin.ID, svdkadmin.HocPhanDK, svdkadmin.TenSV, svdkgv.Diem, svdkadmin.Lop , svdkadmin.MaSV FROM ((svdkadmin
		  INNER JOIN diemsinhvien ON diemsinhvien.ID = svdkadmin.ID)
		...
		If ($result->num_rows > 0) {
            ...
            ?>
					 ...
					 <input type="text" class="d-none" name="id" value='.$dl['MAGiangVien'].'>
				      <center><a href="SVDKAM.php"><button class="btn btn-outline-success">Trở lại</button></a></center>
				</td>
      </div>
    <!-- Optional JavaScript -->
